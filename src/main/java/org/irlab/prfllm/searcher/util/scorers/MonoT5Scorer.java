...
public class MonoT5Scorer {
    ...
    public static class MonoT5Result {
        ...
        public MonoT5Result(boolean isRelevant, double logitTrue, double logitFalse, 
                           double probTrue, double probFalse, double score, String prediction) {
    ...
    public static MonoT5Result evaluate(String query, String document) {
        try {
            ...
            return new MonoT5Result(false, Double.NEGATIVE_INFINITY, 
                                   Double.NEGATIVE_INFINITY, 0.0, 0.0, 0.0, "false");
        }
    }
