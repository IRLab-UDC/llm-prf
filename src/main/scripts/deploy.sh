...
scp "${PROJECT_ROOT}/src/main/python/generate_grid_report.py" "${REMOTE_USER}@${REMOTE_HOST}:${REMOTE_PYTHON_DIR}/"
...
echo "  - JAR: ${REMOTE_BASE_DIR}/ecir26-1.0-jar-with-dependencies.jar"
